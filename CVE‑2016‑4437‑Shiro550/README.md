...
![启动容器截图](./screenshots/docker-up.png)
...
![抓包确认](./screenshots/burp-cookie.png)
...
![加密脚本运行](./screenshots/encrypt-run.png)
...
![Burp 改包](./screenshots/burp-send.png)
...
所有截图放在本目录的 `screenshots/` 文件夹，文件名对应上面占位，后续慢慢补。

---

## 下一步

准备复现 Log4j2，顺便把反弹 shell 的完整命令也整理进来。
